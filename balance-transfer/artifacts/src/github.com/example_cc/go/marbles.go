...
type Marble struct {
	...
	Assettype      string             `json:"assettype"`
        Assetquantity  int                `json:"assetquantity"`
	Assetname      string             `json:"assetname"`    //asset name in mm of marble
	Vin            string             `json:"vin"`    // vin  in mm of marble
	Owner          OwnerRelation      `json:"owner"`
}
type  Order struct {
	ObjectType          string         `json:"docType"` //field for couchdb
	Id                  string         `json:"id"`      //the fieldtags are needed to keep case from bouncing around
        FromCompany         string        `json:"fomcompany"`
        ToCompany           string        `json:"tocompany"`
        Transactiontype     string        `json:"transactiontype"`
	Assetname           string        `json:"assetname"`     
        OrderedQuantity     string       `json:"orderquantity"`
        OrderedDate         string        `json:"orderdate"`
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "init_order" {      //create a new order
		return init_order(stub, args)
       }
